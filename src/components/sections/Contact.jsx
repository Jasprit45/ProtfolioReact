            ...
            <RevealOnScroll>
                <div className="px-4 w-full max-w-3xl mx-auto">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit} action="">
                        ...
                        <button type="submit" className="w-full bg-blue-500 py-3 px-6 rounded font-medium relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]
                        ">Send Message</button>
