    ...
    return <section id="home" className=" min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                I'm a full-stack developer. Turning ideas into scalable full-stack web applications.
            </p>
            ...
            <div className="flex justify-center space-x-4">
                <a href="#projects" className="bg-blue-500 text-white py-3 px-6 rounded
                 font-medium transition relative overflow-hidden hover:-translate-y-0.5
                  hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]"> Views Projects</a>

                <a href="#contact" className="border-blue-500/50 text-blue-500 py-3 px-6
